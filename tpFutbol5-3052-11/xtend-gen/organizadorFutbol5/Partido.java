...
public class Partido {
  ...
  public boolean inscripcionIncompleta() {
    Iterable<Inscripcion> _inscripcionesDeTipo = this.inscripcionesDeTipo("Estandar");
  ...
  public Iterable<Inscripcion> armarListaCandidatos() {
    Iterable<Inscripcion> _inscripcionesDeTipo = this.inscripcionesDeTipo("Estandar");
    Iterable<Inscripcion> _inscripcionesDeTipo_1 = this.inscripcionesDeTipo("Solidaria");
    Iterable<Inscripcion> _plus = Iterables.<Inscripcion>concat(_inscripcionesDeTipo, _inscripcionesDeTipo_1);
    Iterable<Inscripcion> _inscripcionesDeTipo_2 = this.inscripcionesDeTipo("Condicional");
  ...
  public Iterable<Inscripcion> inscripcionesDeTipo(final String tipo) {
    List<Inscripcion> _inscripciones = this.getInscripciones();
    final Function1<Inscripcion,Boolean> _function = new Function1<Inscripcion,Boolean>() {
      public Boolean apply(final Inscripcion inscripcion) {
        ...
        String _queTipoSos = _tipoInscripcion.queTipoSos();
        return Boolean.valueOf(Objects.equal(_queTipoSos, tipo));
      }
    };
